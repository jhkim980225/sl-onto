...
app/            Next.js App Router (페이지 + api/ Route Handlers)
  api/          /ontology /ontology/export /object/[id] /search /nlsearch /infer /fmea-draft /sources
                /ingest /condensation /drawing-input /bom-check /contradictions /curate /quality /schema
