...
pgvector 768-dim(e5-base) + Python 임베딩 사이드카 pyservice) · 그래프 RAG(`/api/ask`, 선택 객체 컨텍스트 질의응답) ·
...
- **배포됨(v82 · pyservice v8):** FEDA K8s ns `sl-ontoground`, NodePort **30494** → `http://192.168.0.100:30494/` (상세 `docs/deployment.md`).
...
| `docs/deployment.md` | Docker standalone → FEDA K8s(v82 · pyservice v8 · 레지스트리 :5000 · NodePort 30494) |
