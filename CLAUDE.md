...
- **배포됨(v84 · pyservice v9):** FEDA K8s ns `sl-ontoground`, NodePort **30494** → `http://192.168.0.100:30494/` (상세 `docs/deployment.md`).
...
| `docs/deployment.md` | Docker standalone → FEDA K8s(v84 · pyservice v9 · 레지스트리 :5000 · NodePort 30494) |
