...
docs/
  ...
  legacy/            과제 문맥 아카이브
    과제요구-구현현황.md
    (시연-시나리오.md 는 2026-07-21 사용자가 삭제 — 아카이브 대상 아님)
```
...
| 여러 문서 | 노드/엣지 170/2156 · 174/2171 · 179/2198 | **180 노드 / 2,199 엣지 / 문서 41** (079c9e4 에서 실측, 램프 캔버스). 전 문서 이 값으로 통일 |
...
~~작업 트리 미커밋 문서 변경을 먼저 커밋~~ → **완료** (079c9e4, 2026-07-21).
한글 파일명 rename 13건 + 신규 features 4건 + 캔버스 범위 문서화가 들어갔다.
이 스펙의 재구성은 그 커밋 위에서 시작한다.
