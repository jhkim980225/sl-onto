...
- 산출물: 설계 검토 체크리스트(제목·인과설명·근거칩·확신도%) → [features/그래프-추론.md](features/legacy-fmea/그래프-추론.md)
...
- [x] **결로 지역별 시나리오**: 지역 탭 + 상세 + 설계도 SVG ([features/결로-시나리오.md](features/legacy-fmea/결로-시나리오.md))
