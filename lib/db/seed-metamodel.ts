...
export const OBJECT_SUBTYPES: SubtypeSeed[] = [
  ...
  { type_id: "item", st_id: "optics", label_ko: "광학", keywords: ["렌즈", "리플렉터", "이너렌즈", "아우터렌즈", "라이트가이드", "프로젝션", "reflector", "lens"] },
  { type_id: "item", st_id: "housing", label_ko: "하우징·기구", keywords: ["하우징", "브라켓", "베젤", "씰", "벤트", "가스켓", "커버", "housing", "bracket", "vent"] },
  { type_id: "item", st_id: "electric", label_ko: "전장", keywords: ["드라이버", "pcb", "커넥터", "와이어", "하네스", "모터", "ecu", "기판", "connector"] },
  { type_id: "item", st_id: "assembly", label_ko: "모듈·어셈블리", keywords: ["어셈블리", "모듈", "assy", "램프", "헤드램프", "리어램프", "drl"] },
  // fm — 고장모드 계열
  { type_id: "fm", st_id: "optical", label_ko: "광학계 고장", keywords: ["광도", "배광", "눈부심", "색", "점등", "조도", "글레어"] },
  { type_id: "fm", st_id: "thermal", label_ko: "열계 고장", keywords: ["과열", "변형", "수축", "크랙", "황변", "열"] },
  { type_id: "fm", st_id: "environment", label_ko: "환경계 고장", keywords: ["결로", "습기", "부식", "침수", "먼지", "수분"] },
  { type_id: "fm", st_id: "electrical", label_ko: "전장계 고장", keywords: ["단선", "쇼트", "플리커", "오작동", "접촉불량", "단락"] },
  { type_id: "fm", st_id: "mechanical", label_ko: "기구계 고장", keywords: ["진동", "소음", "이탈", "파손", "유격", "떨림"] },
  // cause — 원인 계열
  { type_id: "cause", st_id: "design", label_ko: "설계 원인", keywords: ["공차", "형상", "설계", "간섭", "구조"] },
  { type_id: "cause", st_id: "material", label_ko: "재료 원인", keywords: ["재질", "열화", "수지", "소재", "물성"] },
  { type_id: "cause", st_id: "process", label_ko: "공정 원인", keywords: ["성형", "조립", "용접", "사출", "공정"] },
  { type_id: "cause", st_id: "environment", label_ko: "환경 원인", keywords: ["온도", "습도", "진동", "염수", "자외선", "외기"] },
  // action — 조치 계열
  { type_id: "action", st_id: "design-change", label_ko: "설계 변경", keywords: ["설계 변경", "형상 변경", "공차", "구조 변경", "설계변경"] },
  { type_id: "action", st_id: "material-change", label_ko: "재질 변경", keywords: ["재질 변경", "소재", "재질변경", "코팅"] },
  { type_id: "action", st_id: "verification", label_ko: "검증 시험", keywords: ["시험", "테스트", "검증", "평가", "측정"] },
  { type_id: "action", st_id: "process-improve", label_ko: "공정 개선", keywords: ["공정", "조립성", "작업", "관리"] },
  // reg — 관할 지역
